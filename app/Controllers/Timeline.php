...
class Timeline extends Security_Controller {
    ...
    function index() {
        ...
        if (get_array_value($this->login_user->permissions, "message_permission") !== "no") {
            $view_data['team_members'] = $this->Messages_model->get_users_for_messaging($this->get_user_options_for_query($this->login_user->user_type))->getResult();
        }
    ...
    function access_check() {
        $this->Users_model->get_details(array('client_id'=>$this->login_user->id, ))->getResult();
    }
