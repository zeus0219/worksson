                ...
                <div class="card-body"> 
                    ...
                    <div class="form-group">
                        <div class="row">
                          ...
                          <div class="form-group">
                        <div class="row">
                            <label for="client_can_create_departments" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('client_can_create_departments'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("client_can_create_departments", "1", get_setting("client_can_create_departments") ? true : false, "id='client_can_create_departments' class='form-check-input ml15'");
                                ?>                       
                            </div>
                        </div>
                    </div>
                            <div class="form-group">
                        <div class="row">
                            <label for="client_can_edit_departments" class="col-md-2"><?php echo app_lang('client_can_edit_departments'); ?></label>
                            <div class="col-md-10">
                                <?php
                                echo form_checkbox("client_can_edit_departments", "1", get_setting("client_can_edit_departments") ? true : false, "id='client_can_edit_departments' class='form-check-input ml15'");
                                ?>                       
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="form-group">
                        <div class="row">
                            <label for="client_can_view_departments" class="col-md-2"><?php echo app_lang('client_can_view_departments'); ?></label>
                            <div class="col-md-10">
                                <?php
                                echo form_checkbox("client_can_view_departments", "1", get_setting("client_can_view_departments") ? true : false, "id='client_can_view_departments' class='form-check-input ml15'");
                                ?>                       
                            </div>
                        </div>
                    </div>
                         <div class="form-group">
                        <div class="row">
                            <label for="client_can_delete_departments" class="col-md-2"><?php echo app_lang('client_can_delete_departments'); ?></label>
                            <div class="col-md-10">
                                <?php
                                echo form_checkbox("client_can_delete_departments", "1", get_setting("client_can_delete_departments") ? true : false, "id='client_can_delete_departments' class='form-check-input ml15'");
                                ?>                       
                            </div>
                        </div>
                    </div>
