    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class=" col-md-9">
                    <input type="checkbox" name="status" data-on="Public" data-off="Private" value="<?php if($depart_info->status==0){ echo '0';}else{ echo '1';} ?>" <?php if($depart_info->status==1){ echo 'checked';} ?> data-toggle="toggle">
                    <?php
